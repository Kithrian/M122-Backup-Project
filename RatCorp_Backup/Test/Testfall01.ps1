## Testfall01
## Skript zum durchführen des Testfall01, erstellt Test-Protokoll
## Ruft das Backupscript auf und wertet das Ergebnis gemäss Testfall01 aus. 
...
if($different -or !$countCopiedFiles){
    log "Backup Failed"
}else {
