...
## Als Parameter wird das Quell -und Zielverzeichnis erwartet und 0 oder 1 für das deaktivieren / aktivieren des Log in eine Datei
...
# log start of script
log "Running script backup version 1.2"
