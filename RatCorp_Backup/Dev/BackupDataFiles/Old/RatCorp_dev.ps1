 New-Item -Path 'C:\Users\vmadmin\Documents\GitHub\M122-Backup-Project\RatCorp_Backup\Dev\RatCorp' -ItemType Directory
 Set-Location -Path 'C:\Users\vmadmin\Documents\GitHub\M122-Backup-Project\RatCorp_Backup\Dev\RatCorp'
 'Ruedi', 'Hans', 'Rosi' | ForEach-Object { 
    ...
    $folder = New-Item -Path C:\Users\vmadmin\Documents\GitHub\M122-Backup-Project\RatCorp_Backup\Dev\RatCorp\$_\account -ItemType Directory
    ...
    $folder = New-Item -Path C:\Users\vmadmin\Documents\GitHub\M122-Backup-Project\RatCorp_Backup\Dev\RatCorp\$_\hr -ItemType Directory
