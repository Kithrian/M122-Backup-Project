Function Get-FolderName($initialDirector) {
...
$Destination=Get-FolderName Desktop #Copy the Files to this Location
$Versions="5" #How many of the last Backups you want to keep
$BackupDirs=Get-FolderName Desktop #What Folders you want to backup
